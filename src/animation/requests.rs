...
pub(crate) const IDLE_ANIM_IDLE: u8 = 0;
pub(crate) const IDLE_ANIM_REQUESTED: u8 = 1;
...
static IDLE_ANIMATION_PHASE: AtomicU8 = AtomicU8::new(IDLE_ANIM_IDLE);
...
pub fn request_idle_animation() {
    IDLE_ANIMATION_PHASE.store(IDLE_ANIM_REQUESTED, Ordering::Relaxed);
}
...
pub(crate) fn consume_requests() -> AnimationRequests {
    AnimationRequests {
        ...
        idle: IDLE_ANIMATION_PHASE.swap(IDLE_ANIM_IDLE, Ordering::Relaxed),
    }
}
